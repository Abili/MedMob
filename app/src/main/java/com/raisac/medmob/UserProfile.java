...
public class UserProfile extends AppCompatActivity implements
    ...
    private Spinner nDepartments, nExperience;
    private String[] mExp;
    private String[] age;
    private String[] mAge;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        nDepartments = findViewById(R.id.spinner_department);
        nDateofBirth = findViewById(R.id.dateOfBirth);
        nAge = findViewById(R.id.age);
        nExperience = findViewById(R.id.spinner_experience);
        ...
        mAge1 = nAge.getText().toString();
        mDeparment = nExperience.getSelectedItem().toString();
        mExprience = nDepartments.getSelectedItem().toString();
        mDate_of_birth = nDateofBirth.getText().toString();
...
//                        + users.toString());
    ...
    private void populateDepartment() {
        ...
        nDepartments.setAdapter(adapterDepartments);
    ...
    private void populateExperience() {
        ...
        nExperience.setAdapter(adapterExperince);
